...
from jonagram.api.types import KeyboardButton as RawKeyboardButton
from jonagram.api.types import KeyboardButtonRequestPhone, KeyboardButtonRequestGeoLocation
